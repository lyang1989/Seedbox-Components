...
function qBittorrent {
    warn_2
    source <(wget -qO- https://raw.githubusercontent.com/lyang1989/Seedbox-Components/main/Torrent%20Clients/qBittorrent/qBittorrent_install.sh)
...
function Deluge {
    warn_2
    source <(wget -qO- https://raw.githubusercontent.com/lyang1989/Seedbox-Components/main/Torrent%20Clients/Deluge/Deluge_install.sh)
    Deluge_download
    Deluge_install
    Deluge_config

...
function Deluge_download {
 ...
 #      apt-get -qqy install python3-geoip python3-dbus  python3-gi python3-gi-cairo gir1.2-gtk-3.0 gir1.2-appindicator3 python3-pygame libnotify4 librsvg2-common xdg-utils
    ...
    wget https://raw.githubusercontent.com/lyang1989/Seedbox-Components/main/Torrent%20Clients/Deluge/libtorrent/libtorrent-rasterbar_$libtorrent_Ver-amd64.deb
    tput sgr0; clear
}
...
EOF
    ...
    wget https://raw.githubusercontent.com/lyang1989/Seedbox-Components/main/Torrent%20Clients/Deluge/deluge.Userpass.py
    wget https://raw.githubusercontent.com/lyang1989/Seedbox-Components/main/Torrent%20Clients/Deluge/deluge.addHost.py
